                ...
                <?php else: ?>
                    ...
                    <div class="signup-form"><!--sign up form-->
                        ...
                        <form action="#" method="post">
                            ...
                            <input type="password" name="password_repeat" placeholder="Повторите Пароль" value="<?php echo $password_repeat; ?>"/><br>
                            <div class="g-recaptcha" data-sitekey="6LdzQxoTAAAAAPBWEn_CwuriciInb6svw6wPyctx"></div><br>
